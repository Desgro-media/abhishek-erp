...
import { employeeCreateSchema, employeeUpdateSchema, salaryRevisionSchema } from "../../validation/hr.schemas";
...
export const listEmployees: RequestHandler = asyncHandler(async (req, res) => {
  ...
  const { dept, search } = req.query as { dept?: string; search?: string };
